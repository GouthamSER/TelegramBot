...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ɴᴇxᴛ', callback_data='kuttuboT')    
        ], [
        ...
        buttons = [[
             ...
             InlineKeyboardButton('ʙᴀᴄᴋ👈', callback_data='kuttuboT'),
